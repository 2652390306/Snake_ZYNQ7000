...
HD_PWD='E:/FPGA/Project/handwritten_digit_recognition/handwritten-digits-recognition-hls-main-bilibili/sparkroad_project-master/Snake_ZYNQ7000_My/prj/gluttonous_snake.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_rgb_char.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lcd_rgb_char.tcl -notrace
